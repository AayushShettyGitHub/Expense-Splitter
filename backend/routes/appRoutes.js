...
const { addExpense, getExpenses, addRecurringExpense,
  ...
  deleteRecurringExpense, processRecurring } = require('../Controller/expenseController');
const { 
  addExpenseEvent, getExpensesByEvent, getOptimizedEventSettlements,
  getSettlementsByEvent, markEventSettlementPaid, getEventById, deleteExpense
...
const { 
  ...
  removeActiveEvent,
  getActiveEvents, getUserActiveEvents, setTargetEvent, deleteEvent
...
router.post('/recurring/process', protect, processRecurring);
...
router.post("/groups/:groupId/events/:eventId/active", protect,setActiveEvent); 
router.delete("/groups/:groupId/events/:eventId/active",protect, removeActiveEvent); 
router.get("/groups/:groupId/events/active", protect, getActiveEvents); 
...
router.delete("/group/:groupId/event/:eventId", protect, deleteEvent);
...
router.delete("/event/:eventId/expense/:expenseId", protect, deleteExpense);
