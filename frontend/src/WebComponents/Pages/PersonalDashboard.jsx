  ...
  const fetchData = async () => {
    try {
      const [budgetRes, expenseRes] = await Promise.all([
        axios.get(`http://localhost:3000/auth/get?month=${month}&year=${year}`, { withCredentials: true }),
        axios.get(`http://localhost:3000/auth/getExpenses?month=${month}&year=${year}`, { withCredentials: true }),
      ]);
